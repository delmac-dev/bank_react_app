...
import { apple, bill, google } from "../asserts";
    ...
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi illo laboriosam non autem, dolorum corporis delectus exercitationem asperiores veritatis totam perspiciatis qui quisquam.
        </p>
